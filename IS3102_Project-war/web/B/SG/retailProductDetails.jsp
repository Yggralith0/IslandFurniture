                    ...
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div>
                                    <div class="thumbnail">
                                        <img alt="" class="img-responsive img-rounded" src="../../..<%= retailProducts.get(Integer.parseInt(id)).getImageUrl()%>">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="summary entry-summary">
                                    <h2 class="shorter"><strong><%=retailProducts.get(Integer.parseInt(id)).getName()%></strong></h2>
                                    
                                    <p class="price"></p>
                                        <h4 class="amount">
                                            <%= "$" + retailProducts.get(Integer.parseInt(id)).getPrice() + "0"%></h4>
                                        
                                    <strong>Description</strong>
                                    <p class="taller">
                                        <%= retailProducts.get(Integer.parseInt(id)).getDescription()%>
                                    </p>
                                    <div class="product_meta">
                                        <span class="posted_in">Category: <a rel="tag" href="../../ECommerce_AllRetailProductsServlet?cat=<%=retailProducts.get(Integer.parseInt(id)).getCategory()%>"><%= retailProducts.get(Integer.parseInt(id)).getCategory()%></a></span>
                                    </div>
                                    <br/><br/>
